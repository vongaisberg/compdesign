...
public sealed abstract class Node permits BinaryOperationNode, Block, ConstIntNode, JumpCondNode, JumpNode, Phi, ProjNode, ReturnNode, StartNode, UnaryOperationNode {
