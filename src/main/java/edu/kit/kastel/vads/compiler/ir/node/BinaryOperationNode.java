...
public sealed abstract class BinaryOperationNode extends Node permits AddNode, BitAndNode, BitOrNode, BitXorNode, DivNode, EqualsNode, GreaterEqualNode, GreaterThanNode, LessEqualNode, LessThanNode, LogicalAndNode, LogicalOrNode, ModNode, MulNode, NotEqualsNode, ShiftLeftNode, ShiftRightNode, SubNode {
